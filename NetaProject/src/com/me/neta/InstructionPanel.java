	...
	public void content(NetaGame ng) {
		Skin skin = ng.getManager().getSkin();
		 ...
		 String[] items = {
				 ...
				 "Подготовь ИГРОВОЕ ПОЛЕ к игре. Для этого надо проложить извилистый маршрут между СТРАНЦИЯМИ. Нажми на кнопку (      ) "
				 + "и соедини СТАНЦИИ каменной  дорожкой из кружочков или квадратиков. Только не перепутай порядок СТАНЦИЙ!",
				 "Нажми на кнопку (      ) и выбери  одну полоску с буквами  для игры на этом поле.",
				 "Теперь сделай  из КРУЖОЧКОВ, КВАДРАТИКОВ И ДРУГИХ ФИГУР  рядом со стихами  картину – изобрази героев стихотворения."
				 + " Для этого нажми кнопку (      ) и выбери нужные тебе фигуры, перетащи их на ИГРОВОЕ ПОЛЕ.  Обрати внимание на дополнительные кнопки вверху - " +
				 "с их помощью ты можешь пововачивать фигуры, окрашивать их.",
				 ...
				 "Нажми на кнопку СТАРТ. Игра началась! Прикоснись к кубику и передвинь своего героя по дорожке к станции на столько камешков, сколько цифр выпало на кубике.",
				 "Когда придешь на станцию, прочитай стих и найди в нем буквы, такие же, как на цветочках",
				 "Прикоснись к кубику и передвинь своего героя по дорожке к следующей станции  на столько камешков,  сколько цифр "
				 + "выпало на кубике. Если вы играете вдвоем, то шагать  надо по очереди-каждому со своим героем.",
				 ...
				 "Точно так же ты можешь создать игры и с другими стихами , а потом  поиграть с друзьями и знакомыми – "
				 + "ровесниками или взрослыми. Или нажать на кнопку (со стрелкой) прислать сохраненные игровые поля на страничку НИКОЛЬ И ЕЁ ДРУЗЬЯ в фейсбук."
